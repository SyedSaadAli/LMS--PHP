...
<h6 class="n-0 font-weight-bold text-primary">Rider Records
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <form action="edit_rider.php" method="post">
                                ...
                                <button type="submit" name="rider_edit_btn" class="btn btn-success" onclick="javascript: return confirm('Are you sure you want to EDIT this rider  ?')"> EDIT</button>
                            </form>
                        </td>
                        <td>
                            <form action="code.php" method="post">
                                <input type="hidden" name="r_delete_id" value="<?php echo $row['Rider_ID']; ?>">
                                <button type="submit" name="r_delete_btn" class="btn btn-danger" onclick="javascript: return confirm('Are you sure you want to DELETE this rider  ?')"> DELETE</button>
                            </form>
                        </td>
